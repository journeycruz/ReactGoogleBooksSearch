...
function Book(props)
{
    return (
        <div>
            <Row>
                ...
                <Col size="md-6">
                    <div className="text-right p-2">
                        ...
                        {
                            (typeof props.deleteBook !== 'undefinded') &&
            ...
            <img src={props.book.thumbnail} alt={props.book.title} className="float-left p-4"></img>
            <p className="text-left p-4">{props.book.description}</p>
        </div>
    );
}
